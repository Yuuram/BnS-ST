...
nc || (nc = {}), nc.bns || (nc.bns = {}), nc.bns.training || (nc.bns.training = {}),
    function() {
        ...
        nc.bns.training.Model = {}, nc.bns.training.Model.SORT_INPUT_ARR = ["LB", "RB", "F", "TAB", "1", "2", "3", "4", "Z", "X", "C", "V", "Q", "E", "W", "S", "NONE"], nc.bns.training.Model.SORT_INPUT_OBJ = {
                ...
                SM: "Lyn Blade Master",
                WL: "Warlock"
            }, nc.bns.training.Model.SKILL_IMG_URL_FRONT = "http://static.plaync.co.kr/powerbook/bns/ui_resource/skill/", nc.bns.training.Model.NO_TRAINING_DESC = " does not have a skill tree.", nc.bns.training.Model.CATEGORY_MOVE_POSY_PER_MOUSE_WHEEL = 31, nc.bns.training.Model.MIN_LEVEL_CAN_USE_SKILL_POINT = 15, nc.bns.training.Model.MIN_LEVEL_CAN_USE_MASTERY_LEVEL = 50, nc.bns.training.Model.LEVEL_SWITCH_MASTERY_LEVEL_RANGE = 50, nc.bns.training.Model.MASTERY_LEVEL_RANGE_BY_LEVEL_OBJ = {
                50: "20"
    ...
    function(a) {
        ...
        nc.bns.training.select = {}, nc.bns.training.select.SelectLevel = function(b) {
                function c() {
                    ...
                    for (var b, c = j, g = k; g >= c; c++) b = document.createElement("li"), a(b).text(String(c)), a(b).on("click", e),
                        i.appendChild(b), n.push(b);
                ...
                var h, i, j = b.minLevelCanUseSkillPoint,
                    ...
                    o = !1;
                return c(), g
            }, nc.bns.training.select.SelectLevel.SELECT_LEVEL = "SELECT_LEVEL",
            nc.bns.training.select.SelectLevel.OPEN_SELECT_LEVEL = "OPEN_SELECT_LEVEL", nc.bns.training.select.SelectMasteryLevel = function(b) {
                function c() {
    ...
    function(a) {
        ...
        nc.bns.training.category = {}, nc.bns.training.category.Contents = function(b) {
            ...
            function e(a, b, c, d) {
                ...
                e.name2_refine = d, e.initJamoStr = nc.bns.training.util.StringUtil.getInitialJamoStr(d.charAt(0), nc.bns.training.Model.SORT_NAME_ARR), e.learnedSkillVariationId = g.variation_id, e.learnedSkillTooltipAlias = g.tooltip_alias,
                    e.learnedSkillAlias = g.alias;
                var h = "";
            ...
            n.destroy = function() {
                ...
                function b(a, b) {
                    ...
                    if (c) {
                        ...
                        if (o) {
                            o.learnedSkillVariationId = c.variation_id,
                                o.learnedSkillAlias = c.alias, o.learnedSkillTooltipAlias = c.tooltip_alias;
                            var q = null;
                            e.setPrevTrainVariationObj(e, p, c, q),
                                q && o.name2_refine != q.name2_refine && (o.name2_refine = q.name2_refine, o.initJamostr = nc.bns.training.util.StringUtil.getInitialJamoStr(l.name2_refine.charAt(0), nc.bns.training.Model.SORT_NAME_ARR)), o.consumedSkillPoint = nc.bns.training.util.SearchDataUtil.getConsumedSkillPoint(p, g, c.alias)
                        }
                    }
                }
                if (a) {
                    ...
                    var g, h, j, k, l, m = [],
                        n = [];
                    for (var o in a)
                        if (nc.bns.training.util.CheckUtil.available(nc.bns.training.Model.SLOT_OBJ_JSON[o])) g = a[o], h = nc.bns.training.util.SearchDataUtil.getVariationObjHasVariationId(o, g), j = {},
                            j.skillId = String(o), j.learnedSkillVariationId = String(g), j.learnedSkillAlias = h.alias, j.learnedSkillTooltipAlias = h.tooltip_alias,
                            j.name2_refine = h.name2_refine, j.consumedSkillPoint = nc.bns.training.util.SearchDataUtil.getConsumedSkillPoint(nc.bns.training.Model.SLOT_OBJ_JSON[o], g, h.alias), m.push(j);
                        ...
                        case nc.bns.training.Model.SKILL_TYPE_ACQUISITION:
                            ...
                            if (s) {
                                ...
                                var y = null;
                                e.setPrevTrainVariationObj(e, r, q, y), y && l.name2_refine != y.name2_refine && (l.name2_refine = y.name2_refine, l.initJamostr = nc.bns.training.util.StringUtil.getInitialJamoStr(l.name2_refine.charAt(0), nc.bns.training.Model.SORT_NAME_ARR)),
                                    l.consumedSkillPoint = nc.bns.training.util.SearchDataUtil.getConsumedSkillPoint(r, g, q.alias)
                            }
                            break;
                    ...
                    if (w) {
                        f(), v = i(u), w.sortListBySortOptionIndex(v, u);
                        for (var G, H, I = nc.bns.training.util.SearchDataUtil.getShareSkillListObjArrFromCustomGlobalModelArr(),
                            J = 0, K = m.length; K > J; J++) {
                            G = m[J];
            ...
            function d(b) {
                for (var c, d = 0, e = j.length; e > d; d++) c = j[d],
                    c.index != b ? a(c).removeClass("selected") : a(c).addClass("selected")
            }
            var e = this;
            e.destroy = function() {
                if (j)
                        ...
                        for (var x = 0, y = h.length; y > x; x++) {
                            ...
                            if ("" !== m.learnedSkillVariationId && (m.name2_refine = c(m, m.learnedSkillVariationId)), e = nc.bns.training.Model.SORT_INPUT_OBJ[m.default_keycap].value, n = '<span class="thumb"><img src="' + o + '"></span><em class="name">' + m.name2_refine + '</em><span class="cmdkey">' + e + '</span><span class="frame"></span><span class="point"></span>', a(k).append(n), "" !== e && a(".cmdkey", k).addClass("key_" + e), nc.bns.training.Model.level < m.pc_level) a(k).addClass("lock");
                                ...
                                case nc.bns.training.Model.SKILL_TYPE_ACQUISITION:
                                    ...
                                    break;
                                case nc.bns.training.Model.SKILL_TYPE_HIDDEN:
                                    a(k).addClass("hide");
                                    break;
            ...
            function g(a) {
                for (var b, c = 0, d = v.length; d > c; c++) b = v[c],
                    b.getSkillId() != a ? b.deactivate() : b.activate()
            }

            function h(a) {
                for (var b, c = 0, d = v.length; d > c; c++) b = v[c],
                    b.getContainer() != a ? b.deactivate() : b.activate()
            }
                ...
                switch (b.type) {
                    ...
                    case "DOMMouseScroll":
                        // var c = -b.originalEvent.wheelDelta || b.originalEvent.detail,
                            // d = c > 0 ? nc.bns.training.Model.CATEGORY_MOVE_POSY_PER_MOUSE_WHEEL : -nc.bns.training.Model.CATEGORY_MOVE_POSY_PER_MOUSE_WHEEL,
                            // e = a(r).height() - a(q).height(),
                            // f = parseInt(a(r).css("top")) - d; - e > f && (f = -e), f > 0 && (f = 0), a(r).css("top", f), nc.bns.training.Model.wheelScrollCategoryContainerPosY = f
                }
            }
            ...
            p.destroy = function() {
                ...
                if (e) {
                    for (var h, i = c.getContainer(), j = a("> dl", r),
                        k = !1, l = 0, m = j.length; m > l; l++)
                        if (h = j[l], a(h).has(i)) {
                            k = !0;
                            break
                        }
    ...
    function($) {
        nc.bns.training.util = {}, nc.bns.training.util.StringUtil = {
            ...
            return d.makeTrainSkillVariationObjArr = function(d, e) {
                ...
                for (var j in a) {
                    ...
                    for (var k in f)
                        ...
                        prevTrainAliasStr = g.prev_train[0], c.push(g),
                            i = !0, h = !0;
                        break
                    }
                    if (h) break
            ...
            function init($flag_initializeFirst, $jsonObj) {
                ...
                function selectLevelEventHandler(a) {
                    switch (a.preventDefault(), a.stopPropagation(), a.type) {
                                ...
                                switch (e < nc.bns.training.Model.MIN_LEVEL_CAN_USE_MASTERY_LEVEL ? d = "level50Under" : e >= nc.bns.training.Model.LEVEL_SWITCH_MASTERY_LEVEL_RANGE && (d = "level50Over"), d) {
                                    case "level50Under":
                                        nc.bns.training.Model.level = b, nc.bns.training.Model.masteryLevel = 0, nc.bns.training.Model.skillPointTotal = nc.bns.training.Model.level - nc.bns.training.Model.MIN_LEVEL_CAN_USE_SKILL_POINT + 1 + nc.bns.training.util.ObjectUtil.getAccumulatedNumberVal(nc.bns.training.Model.MASTERY_LEVEL_POINTS, String(nc.bns.training.Model.masteryLevel)), nc.bns.training.Model.skillPointRemained = nc.bns.training.Model.skillPointTotal - nc.bns.training.Model.skillPointConsumed,
                                            _categoryContents.sortListBySortOptionIndexByExternal(),
                                            _categoryContents.activateCategorySkillListBySkillId(nc.bns.training.Model.lastSelectedSkillListSkillId),
                        ...
                        case nc.bns.training.select.SelectLevel.OPEN_SELECT_LEVEL:
                            _selectMasteryLevel && _selectMasteryLevel.openByExternal(!1),
                                setBodyMouseInteractionForCloseMasteryLevelSelectUI(!0)
                    }
                }

                function setBodyMouseInteractionForCloseMasteryLevelSelectUI(a) {
                    $("body").unbind("click", bodyMouseEventHandler),
                        a && $("body").bind("click", bodyMouseEventHandler)
                }

                function bodyMouseEventHandler(a) {
                    switch (a.preventDefault(), a.stopPropagation(), a.type) {
                        case "click":
                            _selectLevel && _selectLevel.openByExternal(!1), _selectMasteryLevel && _selectMasteryLevel.openByExternal(!1),
                                setBodyMouseInteractionForCloseMasteryLevelSelectUI(!1)
                    }
                }
                ...
                function selectMasteryLevelEventHandler(a) {
                    switch (a.preventDefault(), a.stopPropagation(), a.type) {
                        case nc.bns.training.select.SelectMasteryLevel.OPEN_MASTERY_SELECT_LEVEL:
                            _selectLevel && _selectLevel.openByExternal(!1), _selectMasteryLevel && _selectMasteryLevel.openByExternal(!0),
                                setBodyMouseInteractionForCloseMasteryLevelSelectUI(!0);
                            break;
                                ...
                                case "":
                                    switch (f) {
                                        case nc.bns.training.Model.SLOT_ACQUISITION:
                                            _categoryContents.consumePointToSkillListInCategoryContainer(c, i),
                                                _tooltipContents.setSkillToolTip(nc.bns.training.Model.lastSelectedSkillListSkillId), j = !1;
                                            break;
                                        case "":
                                        ...
                                        case nc.bns.training.Model.SLOT_REPLACE:
                                            if (!g) return;
                                            _categoryContents.consumePointToSkillListInCategoryContainer(c, i),
                                                _categoryContents.replaceSkillListInCategoryContainer(b, g.variationId, g.alias, g.skillName), _tooltipContents.setSkillToolTip(nc.bns.training.Model.lastSelectedSkillListSkillId), j = !0, k = c
                                    }
                                    break;
                                case nc.bns.training.Model.SKILL_TYPE_ACQUISITION:
                                    switch (f) {
                                        ...
                                        case nc.bns.training.Model.SLOT_REPLACE:
                                            if (!g) return;
                                            _categoryContents.consumePointToSkillListInCategoryContainer(c, i),
                                                _categoryContents.replaceSkillListInCategoryContainer(b, g.variationId, g.alias, g.skillName), _tooltipContents.setSkillToolTip(nc.bns.training.Model.lastSelectedSkillListSkillId), j = !0, k = nc.bns.training.Model.lastSelectedSkillListSkillId
                                    }
                                    break;
                                case nc.bns.training.Model.SKILL_TYPE_SHARE:
                                    switch (f) {
                ...
                var objArr = [];
                $.extend(!0, objArr, nc.bns.training.Model.CATEGORY_OBJ_ARR),
                    nc.bns.training.Model.DATA_SKILL_TOOLTIP_OBJ_JSON = data_skill_tooltip, nc.bns.training.Model.DATA_SKILL_TOOLTIP_ATTRIBUTE_OBJ_JSON = data_skill_tooltip_attribute;
                for (var _tmpObj, initialStr, i = 0, max = objArr.length; max > i; i++) {
                    ...
                    if (_tmpObj.skill_id == 27400) {
                        _tmpObj.skillType = nc.bns.training.Model.SKILL_TYPE_HIDDEN;
                    }
                ...
                } else _categoryContents.activateCategorySkillListBySkillId(nc.bns.training.Model.lastSelectedSkillListSkillId), _treeContents.setSkillTree(nc.bns.training.Model.lastSelectedSkillListSkillId),
                    _tooltipContents.setSkillToolTip(nc.bns.training.Model.lastSelectedSkillListSkillId);
                flag_canUseSelectMastery ? (bindMasterySelectLevelInteraction(!0), _selectMasteryLevel.switchMasteryLevelLange(parseInt(nc.bns.training.Model.MASTERY_LEVEL_RANGE_BY_LEVEL_OBJ[String(nc.bns.training.Model.LEVEL_SWITCH_MASTERY_LEVEL_RANGE)])), _selectMasteryLevel.displayMasteryLevel(nc.bns.training.Model.masteryLevel), _selectMasteryLevel.setMouseInteraction(!0)) : (bindMasterySelectLevelInteraction(!1), _selectMasteryLevel.setMouseInteraction(!1)),
                    _selectLevel.displayLevel(nc.bns.training.Model.level),
                    _selectMasteryLevel.displayMasteryLevel(nc.bns.training.Model.masteryLevel)
            }

            function getTrainAllSkillJsonData() {
                for (var a, b, c = nc.bns.training.Model.CUSTOM_CATEGORY_OBJ_ARR,
            ...
            function resetTreeContentsAndTooltipContentsBySkillId(a) {
                ...
                switch (d.skillType) {
                    case nc.bns.training.Model.SKILL_TYPE_NONE:
                        nc.bns.training.Model.lastSelectedSkillType = nc.bns.training.Model.SKILL_TYPE_NONE,
                            _treeContents.setSkillTree(c),
                            _tooltipContents.setSkillToolTip(c);
                        break;
                    case nc.bns.training.Model.SKILL_TYPE_ACQUISITION:
                        nc.bns.training.Model.lastSelectedSkillType = nc.bns.training.Model.SKILL_TYPE_ACQUISITION,
                            b = String(d.tree_id), _treeContents.setTreeIdSkillTree(b, c), _tooltipContents.setSkillToolTip(c);
                        break;
                    case nc.bns.training.Model.SKILL_TYPE_SHARE:
                        ...
                        break;
                    default:
                        nc.bns.training.Model.lastSelectedSkillType = "", _treeContents.resetSkillTreeBySkillId(c),
                            _tooltipContents.setSkillToolTip(c)
                }
            ...
            function setTreeContentsAndTooltipContentsBySkillId(a) {
                ...
                switch (d.skillType) {
                    ...
                    case nc.bns.training.Model.SKILL_TYPE_SHARE:
                        ...
                        break;
                    default:
                        nc.bns.training.Model.lastSelectedSkillType = "", _treeContents.setSkillTree(c),
                            _tooltipContents.setSkillToolTip(c)
                }
                nc.bns.training.Model.lastSelectedSkillListSkillId = c
            }
            ...
            function resettingByJsonDataObj(a) {
                init(!1, a), setSkillListStatusInCategoryByData(a.json_slot_data),
                    resetTreeContentsAndTooltipContentsBySkillId(nc.bns.training.Model.lastSelectedSkillListSkillId);
                ...
                _treeContents.displaySkillPointConsumedByExternal(c),
                    nc.bns.training.Model.skillPointConsumed = c, nc.bns.training.Model.skillPointRemained = nc.bns.training.Model.skillPointTotal - nc.bns.training.Model.skillPointConsumed,
                    nc.bns.training.Model.skillPointRemained <= 0 && _treeContents.resetSkillTreeBySkillId(String(nc.bns.training.Model.lastSelectedSkillListSkillId))
            }
            ...
            _this.resetSelectedSkill = function() {
                    ...
                    if (b) {
                        ...
                        if ("" != b.learnedSkillVariationId) {
                            var e = b.consumedSkillPoint,
                                ...
                                g = b.initName2Refine,
                                h = !1;
                            f != g && (h = !0), b.consumedSkillPoint = 0, b.learnedSkillVariationId = "", b.learnedSkillTooltipAlias = "", b.learnedSkillAlias = "", b.name2_refine = g, b.initJamoStr = nc.bns.training.util.StringUtil.getInitialJamoStr(g.charAt(0), nc.bns.training.Model.SORT_NAME_ARR),
                                nc.bns.training.Model.skillPointConsumed = nc.bns.training.Model.skillPointConsumed - e, nc.bns.training.Model.skillPointRemained = nc.bns.training.Model.skillPointTotal - nc.bns.training.Model.skillPointConsumed;
                ...
                var a = nc.bns.training.Model.lastSelectedSkillListSkillId,
                    b = nc.bns.training.Model.lastSelectedSkillType,
                    c = nc.bns.training.util.SearchDataUtil.getSkillListObjFromCustomGlobalModelArr(nc.bns.training.Model.lastSelectedSkillListSkillId);
                if (c) {
                    if (c.skillType != nc.bns.training.Model.SKILL_TYPE_NONE) {
                        var d = nc.bns.training.util.SearchDataUtil.getSkillListObjFromCustomGlobalModelArr(c.tree_id),
                            e = c.skill_id,
                            f = d.tree_id;
                        init(!0), _categoryContents.activateCategorySkillListBySkillId(e), _treeContents.resetSkillTreeBySkillId(f), _tooltipContents.setSkillToolTip(e)
                    } else init(!0), _categoryContents.activateCategorySkillListBySkillId(a), _treeContents.resetSkillTreeBySkillId(a),
                        _tooltipContents.setSkillToolTip(a);
                    nc.bns.training.Model.lastSelectedSkillListSkillId = a, nc.bns.training.Model.lastSelectedSkillType = b, nc.bns.training.Model.wheelScrollCategoryContainerPosY = 0
                }
                ...
                function a() {
                        ...
                        return e.makeTrainSkillVariationArr = function(e, f) {
                            ...
                            for (var k in a) {
                                ...
                                for (var l in g)
                                    ...
                                    prevTrainAliasStr = h.prev_train[0], d.unshift(h),
                                        j = !0, i = !0;
                                    break
                                }
                                if (i) break
                    ...
                    for (var b, c, d = nc.bns.training.Model.CUSTOM_CATEGORY_OBJ_ARR,
                        e = {}, f = 0, g = d.length; g > f; f++)
            ...
            var _contents, _categoryContents, _treeContents,
                _tooltipContents, _selectLevel, _selectMasteryLevel,
                flag_canUseSelectMastery = !0;
            return init(!0), _this
            ...
            function d(a) {
                ...
                function h() {
                                    ...
                                    for (var f, s = 0, t = M.length; t > s; s++)
                                        if (f = M[s], f["target-attribute"] == e["target-attribute"] && f["effect-attribute"] == e["effect-attribute"] && f["condition-attribute"] == e["condition-attribute"]) {
                                            if (f["effect-arg-1"] != e["effect-arg-1"] || f["effect-arg-2"] != e["effect-arg-2"] || f["effect-arg-3"] != e["effect-arg-3"] || f["effect-arg-4"] != e["effect-arg-4"]) {
                                                for (var u = f["effect-attribute"],
                                                    v = nc.bns.training.Model.DATA_SKILL_TOOLTIP_ATTRIBUTE_OBJ_JSON[u.toLowerCase()],
                                                    w = -1,
                                                    p = 1; 4 >= p; p++)
                                            ...
                                            if (f["condition-arg-1"] != e["condition-arg-1"] || f["condition-arg-2"] != e["condition-arg-2"])
                                                if (b(f)) V = $(k).clone(),
                                                    V.html(e.title + n + l),
                                                    Z.push(V),
                                                    nc.bns.training.util.ArrayUtil.removeElement(O, e),
                                                    nc.bns.training.util.ArrayUtil.removeElement(R, e),
                                                    o = !0;
                                                else {
                                                    ...
                                                    switch (x) {
                                                        case "C_during_skill":
                                                            V = $(k).clone(),
                                                                ...
                                                                U.html(f.title),
                                                                Z.push(U),
                                                                nc.bns.training.util.ArrayUtil.removeElement(Q, e),
                                                                nc.bns.training.util.ArrayUtil.removeElement(R, e),
                                                                nc.bns.training.util.ArrayUtil.removeElement(M, f),
                                                                o = !0;
                                                            break;
                                        ...
                                        if (f = M[s], f["target-attribute"] == e["target-attribute"] && f["effect-attribute"] == e["effect-attribute"] && f["condition-attribute"] == e["condition-attribute"]) {
                                            ...
                                            if (f["condition-arg-1"] != e["condition-arg-1"] || f["condition-arg-2"] != e["condition-arg-2"])
                                                if (b(f)) V = $(k).clone(),
                                                    V.html(e.title + n + l),
                                                    _.push(V),
                                                    nc.bns.training.util.ArrayUtil.removeElement(P, e),
                                                    nc.bns.training.util.ArrayUtil.removeElement(R, e),
                                                    o = !0;
                                                else {
                                                    var x = f["condition-attribute"];
                    ...
                    var S, T, U, V, W = document.createElement("div"),
                        ...
                        _ = [],
                        ab = [];
                    O.length > 0 && d(), P.length > 0 && e(), Q.length > 0 && f(), g(), r(), h(), s(), q(), t(), o.setAllInfoByExternal(W.innerHTML, X.innerHTML, Y.innerHTML),
                        o.setSkillNameByExternal(G), o.setSkillThumbnailByExternal(G), o.setHealPointChangeDescByExternal(F, G), p.displaySkillInfoDiff(F, G)
                }
                ...
                function v(a, b, c) {
                    H = String(a.tooltipAlias).toLowerCase(), I = String(b.tooltipAlias).toLowerCase(), h(),
                        d(c)
                }
                    ...
                    case "":
                        switch (D) {
                            case "":
                                ...
                                break;
                            case nc.bns.training.Model.SLOT_REPLACE:
                                y = nc.bns.training.Model.COLLECTION_ARRAY_HAS_SKILL_OBJ_JSON_BY_SKILL_ID[B], E = nc.bns.training.util.SearchDataUtil.getSkillListObjFromCustomGlobalModelArr(B), F = nc.bns.training.Model.SKILL_OBJ_JSON[E.learnedSkillTooltipAlias],
                                    G = nc.bns.training.Model.SKILL_OBJ_JSON[A.tooltip_alias], v(F, G, A);
                                break;
                            case nc.bns.training.Model.SLOT_ACQUISITION:
                                y = nc.bns.training.Model.COLLECTION_ARRAY_HAS_SKILL_OBJ_JSON_BY_SKILL_ID[B], E = nc.bns.training.util.SearchDataUtil.getSkillListObjFromCustomGlobalModelArr(B);
                            ...
                            case nc.bns.training.Model.SLOT_ACQUISITION:
                                if (x.skill_id != A.skill_id) {
                                    ...
                                    if (K) {
                                        ...
                                        G = f(A.tooltip_alias, y),
                                            w(F, G, G.id), A.skill_id != G.id ? s.displayAcquire(!1) : e(A), c(A)
                                    } else {
                    ...
                    case nc.bns.training.Model.SKILL_TYPE_SHARE:
                        switch (D) {
                            case "":
                                ...
                                break;
                            case nc.bns.training.Model.SLOT_REPLACE:
                                y = nc.bns.training.Model.COLLECTION_ARRAY_HAS_SKILL_OBJ_JSON_BY_SKILL_ID[x.skill_id], z = y[0],
                                    F = nc.bns.training.Model.SKILL_OBJ_JSON[b(z.tooltipAlias)], F || (F = nc.bns.training.Model.SKILL_OBJ_JSON[z.tooltipAlias]), G = f(A.tooltip_alias, y), G || (G = y[0]), w(F, G, x.skill_id),
                                    e(A), c(A);
                                break;
                            case nc.bns.training.Model.SLOT_ACQUISITION:
                                u(C, A)
            ...
            var j = '<img src="https://dl.dropboxusercontent.com/u/74733627/BNS%20ST/img/skill_ui_mod.png">',
                k = document.createElement("span");
            $(k).addClass("ui_skill_add");
            var l = '<img src="https://dl.dropboxusercontent.com/u/74733627/BNS%20ST/img/skill_ui_add.png" />',
                ...
                if (j.tree_id !== j.skill_id)
                    if (j.skillType != nc.bns.training.Model.SKILL_TYPE_NONE) {
                        ...
                        if ("" != k.learnedSkillTooltipAlias) switch (j.skillType) {
                            case nc.bns.training.Model.SKILL_TYPE_ACQUISITION:
                                ...
                                if (n.length <= 0) {
                                    ...
                                    if (z)
                                        ...
                                        h = i[0], o.displayDesc(h),
                                            p.displaySkillInfo(h),
                                            b(j), s.displayAcquire(!1);
                            ...
                            i = nc.bns.training.Model.COLLECTION_ARRAY_HAS_SKILL_OBJ_JSON_BY_SKILL_ID[a], h = i[0], o.displayDesc(h),
                                p.displaySkillInfo(h), b(j), s.displayAcquire(!1);
            ...
            c.destroy = function() {}, c.displayUseCondition = function(a) {
                ...
                d.html("");
                var b = '<img src="http://static.plaync.co.kr/powerbook/bs1/tr2/img/achievement.png" />',
                    c = " <span> " + a + "</span>",
            ...
            function c(a) {
                ...
                switch (a.type) {
                    case nc.bns.training.tree.SkillTree.CONSUME_SKILL_POINT:
                        b = a.skillId, c = a.treeId, d = a.prevTrainSkillIdArr,
                            e = a.skillType, f = a.slotType,
                            swtichSkillData = a.switchSkillData, g = a.variationData,
                            h = a.required_tp, $(i).trigger({
            ...
            function f() {
                for (var a, b = 0, c = v.length; c > b; b++) a = v[b],
                    i(a, nc.bns.training.tree.SkillSlotItem.CLICK_SKILL_SLOT_ITEM, l), i(a, nc.bns.training.tree.SkillSlotItem.CLICK_MOUSE_RIGHT_BUTTON, l), a.destroy();
                v = []
            }
            ...
            function g(a, b) {
                ...
                if (w)
                            ...
                            for (var z in a) {
                                ...
                                for (var A in x)
                                    if (y = x[A], w.learnedSkillAlias == y.alias && w.learnedSkillVariationId == y.variation_id) {
                                        for (var B, C, D, E = j(z), F = q.getConnectionArrTotal(),
                                            G = !1, g = 0, i = F.length; i > g; g++) {
                                            C = F[g];
                                        ...
                                        if (parseInt(A) >= parseInt(y.max_variation_level)) {
                                            ...
                                            E.setSlotStatus(nc.bns.training.tree.SkillSlotItem.STATUS_COMPLETE),
                                        ...
                                        for (var Q, B, g = 0, i = K.length; i > g; g++) Q = K[g], B = j(Q.prevTrainSlotNo),
                                            B.setSlotStatus(nc.bns.training.tree.SkillSlotItem.STATUS_COMPLETE)
                                    }
                            }
                        } else {
                            var x, y;
                            for (var z in a) {
                                ...
                                for (var A in x)
                                    if (y = x[A], w.learnedSkillAlias == y.alias && w.learnedSkillVariationId == y.variation_id) {
                                        ...
                                        for (var B, C, D, F = q.getConnectionArrTotal(),
                                            G = !1, g = 0, i = F.length; i > g; g++) {
                                            C = F[g];
                                            var H = nc.bns.training.util.ArrayUtil.indexOf(C, E.getSlotNo());
                                            if (G = H >= 0 ? !0 : !1)
                    ...
                    if (!R) return;
                    if (nc.bns.training.Model.editable) {
                        var S = a[nc.bns.training.Model.FIRST_ITEM_SLOT_NO]
                            [1];
            ...
            function l(a) {
                function b(a, b) {
                    for (var c, d, g, k, n = q.getConnectionArrTotal(),
                        o = !1, p = 0, r = n.length; r > p; p++)
                        if (c = n[p], d = nc.bns.training.util.ArrayUtil.indexOf(c, f), o = d >= 0 ? !0 : !1)
                            for (var s, t = parseInt(f.charAt(0)),
                                u = 0, w = c.length; w > u; u++) g = c[u], k = j(g), s = parseInt(g.charAt(0)), t > s && (i(k, nc.bns.training.tree.SkillSlotItem.CLICK_MOUSE_RIGHT_BUTTON, l), i(k, nc.bns.training.tree.SkillSlotItem.CLICK_SKILL_SLOT_ITEM, l));
                        else
                ...
                function c() {
                    for (var a, b, c, d, g = q.getConnectionArrTotal(),
                        k = !1, n = 0, o = g.length; o > n; n++)
                    ...
                    for (var a, b, k = !1, n = 0, o = g.length; o > n; n++)
                        if (a = g[n], b = nc.bns.training.util.ArrayUtil.indexOf(a, e.getSlotNo()), k = b >= 0 ? !0 : !1)
                            for (var c, d, p = 0, r = a.length; r > p; p++) c = a[p], d = j(c), i(d, nc.bns.training.tree.SkillSlotItem.CLICK_MOUSE_RIGHT_BUTTON, l),
                                i(d, nc.bns.training.tree.SkillSlotItem.CLICK_SKILL_SLOT_ITEM, l), d.getSlotFrameType() != nc.bns.training.tree.SkillSlotItem.TYPE_FRAME_LEGEND ? d.setSlotStatus(nc.bns.training.tree.SkillSlotItem.STATUS_IMPOSSIBLE) : d.setMouseInteraction(!1);
                    var s = q.activateArrowsFromRootToSlotAndGetArrowInfoObj(f);
                    q.activateArrowsFromSlotToChildSlots(f), e.addVariationStatusValue(),
                        m(e), e.getFlagRemainVariation() && q.deactivateArrowsFromSlotToChildSlots(f);
                ...
                switch (a.type) {
                    case nc.bns.training.tree.SkillSlotItem.CLICK_SKILL_SLOT_ITEM:
                        ...
                        switch (f = e.getSlotNo(), k = a.variationData.skill_id, o = a.variationData.tree_id, r = a.variationData, nc.bns.training.Model.lastSelectedSkillType) {
                            ...
                            case nc.bns.training.Model.SKILL_TYPE_SHARE:
                                var s = nc.bns.training.util.SearchDataUtil.getPrevTrainedAllSkillId(nc.bns.training.Model.SLOT_OBJ_JSON[o], r.alias);
                                g = nc.bns.training.util.SearchDataUtil.getSkillListObjFromCustomGlobalModelArr(o), g.learnedSkillVariationId = String(a.variationData.variation_id),
                                    g.learnedSkillTooltipAlias = String(a.variationData.tooltip_alias),
                                    g.learnedSkillAlias = String(a.variationData.alias);
                                var t = nc.bns.training.Model.skillPointRemained - r.required_tp;
                                0 >= t ? c() : b(nc.bns.training.Model.SLOT_OBJ_JSON[o], t), k != o ? $(p).trigger({
                                    type: nc.bns.training.tree.SkillTree.CONSUME_SKILL_POINT,
                                    skillId: k,
                    ...
                    case nc.bns.training.tree.SkillSlotItem.CLICK_MOUSE_RIGHT_BUTTON:
                        ...
                        switch (nc.bns.training.Model.lastSelectedSkillType) {
                            ...
                            case nc.bns.training.Model.SKILL_TYPE_SHARE:
                                ...
                                if (0 > B) return;
                                if (0 === B) g.name2_refine != g.initName2Refine && (x = !0), g.learnedSkillVariationId = "", g.learnedSkillTooltipAlias = "",
                                    g.learnedSkillAlias = "", g.name2_refine = g.initName2Refine, g.initJamoStr = nc.bns.training.util.StringUtil.getInitialJamoStr(g.name2_refine.charAt(0), nc.bns.training.Model.SORT_NAME_ARR),
                                    g.consumedSkillPoint = 0;
                                else {
                                    var E = z[B - 1];
            ...
            function b() {
                ...
                r = [];
                for (var f, g = 0, h = b.length; h > g; g++) f = b[g][1],
                    f.slotNo = a[g], r.push(f);
                q = [];
            ...
            function c(a, b, d) {
                if (d) {
                    ...
                    t = [];
                    var e = a[0];
                    t.unshift(e.slotNo), t.unshift(e.prevTrainSlotNo),
                        a.shift()
                }
            ...
            function d(a, b, c) {
                ...
                if (f != q) {
                    ...
                    if (F.length > 0) {
                        ...
                        if (parseInt(o) <= parseInt(K)) v = parseInt(d - 1) * i + g, w = parseInt(f - 1) * j + h,
                            y = 1 >= t ? k - l : t * i - m - l, z.style.top = v + "px", z.style.left = w + "px", z.style.width = n + "px", z.style.height = y + "px", x = u * j, A.style.height = n + "px",
                            A.style.top = v + y + "px", A.style.left = w + "px", A.style.width = x + "px", B.style.top = parseInt(A.style.top) + "px", B.style.left = w + x - 3 + "px";
                        else {
                            var L = parseInt(K) - d;
                            v = parseInt(d - 1) * i + g, w = parseInt(f - 1) * j + h, y = 1 >= L ? k - l : L * i - m - l, z.style.top = v + "px", z.style.left = w + "px", z.style.width = n + "px", z.style.height = y + "px", x = u * j, A.style.height = n + "px", A.style.top = v + y + "px", A.style.left = w + "px",
                                A.style.width = x + "px";
                    ...
                    } else v = parseInt(d - 1) * i + g, w = parseInt(f - 1) * j + h, y = 1 >= t ? k - l : t * i - m - l, z.style.top = v + "px", z.style.left = w + "px", z.style.width = n + "px", z.style.height = y + "px", x = u * j, A.style.height = n + "px",
                        A.style.top = v + y + "px", A.style.left = w + "px", A.style.width = x + "px", B.style.top = parseInt(A.style.top) + "px", B.style.left = w + x - 3 + "px"
                } else t = parseInt(o) - parseInt(d), v = parseInt(d - 1) * i + g, w = parseInt(f - 1) * j + h, y = 1 >= t ? k - l : t * i - m - l, z.style.top = v + "px",
                    z.style.left = w + "px", z.style.width = n + "px",
                    z.style.height = y + "px", A.style.display = "none",
                    B.style.left = w - 3 + "px", B.style.top = parseInt(z.style.top) + parseInt(z.style.height) + "px";
                var O = {
                    container: s,
            ...
            f.destroy = function() {
                ...
                for (var g, h = 0, f = d.length; f > h; h++) g = d[h],
                    $(g).addClass("able");
                ...
                if (j) {
                    d = [];
                    for (var e = 0, f = q.length; f > e; e++) b = q[e],
                        b.slotNo != a && b.prevTrainSlotNo == i.prevTrainSlotNo && d.push(b.container);
                    for (var h = 0, f = d.length; f > h; h++) g = d[h],
                        $(g).removeClass("able")
                }
                ...
                for (var e, f = 0, g = c.length; g > f; f++) e = c[f].container,
                    $(e).addClass("able");
                return c
                ...
                for (var b, c = [], d = nc.bns.training.Model.SLOT_OBJ_JSON[String(a)], f = nc.bns.training.util.ObjectUtil.getElementKeyNameArr(d), g = nc.bns.training.util.ObjectUtil.getElementArr(d), h = [], i = 0, j = g.length; j > i; i++) b = g[i][1], b.slotNo = f[i],
                    h.push(b);
                ...
                p.setArrowConnectionArr = function(a, b, d, e) {
                    if (e) {
                        ...
                        o = [];
                        var f = b[0];
                        o.unshift(f.slotNo), o.unshift(f.prevTrainSlotNo),
                            b.shift()
                    }
            ...
            function g(a) {
                switch (a) {
                    ...
                    case nc.bns.training.tree.SkillSlotItem.STATUS_PLUS_STEP:
                        s.removeClass().addClass(v).addClass("plusstep"),
                            i(!0), x = !1;
                        break;
                    case nc.bns.training.tree.SkillSlotItem.STATUS_COMPLETE:
                        s.removeClass().addClass(v).addClass("complete"),
                            i(!0), p = o, f(p), w = "", x = !0;
                        break;
